...
test_10_log = prefix+'_TEST_LOG 10_TOKENS_INFERENCE.txt'
test_20_log = prefix+'_TEST_LOG 20_TOKENS_INFERENCE.txt'
test_30_log = prefix+'_TEST_LOG 30_TOKENS_INFERENCE.txt'
test_40_log = prefix+'_TEST_LOG 40_TOKENS_INFERENCE.txt'
test_50_log = prefix+'_TEST_LOG 50_TOKENS_INFERENCE.txt'
...
def read_datasets():
    ...
    if model_name=='NonZeroReLUCounter':
        with open('Dyck1Dataset10Tokens.txt', 'r') as f:
            for line in f:
                line = line.split(",")
                sentence = line[0].strip()
                label = line[1].strip()
                x_10.append(sentence)
                y_10.append(label)
        ...
        with open('CounterDataset10Tokens.txt', 'r') as f:
            for line in f:
                line = line.split(",")
                sentence = line[0].strip()
                label = line[1].strip()
    ...
    return x, y, x_10, y_10, x_20, y_20, x_30, y_30, x_40, y_40, x_50, y_50
...
X_train, y_train, X_10, y_10, X_20, y_20, X_30, y_30, X_40, y_40, X_50, y_50 = read_datasets()

X_train_notencoded = X_train
y_train_notencoded = y_train
X_train, y_train = encode_dataset(X_train, y_train)

X_10_notencoded = X_10
y_10_notencoded = y_10
X_10, y_10 = encode_dataset(X_10, y_10)
...
def test(model, X, X_notencoded, y, y_notencoded, dataset):
    ...
    elif dataset=='test_10':
        log_file = test_10_log
...
def main():
    ...
    for i in range(num_runs):
        ...
        with open(file_name, "a") as f:
            ...
            f.write('test 10 accuracy for run ' + str(i) + ' = ' + str(test_10_accuracy) + '%\n')
    ...
    min_test_10_accuracy = min(test_10_accuracies)
    avg_test_10_accuracy = sum(test_10_accuracies) / len(test_10_accuracies)
    std_test_10_accuracy = np.std(test_10_accuracies)
    ...
    with open(file_name, "a") as f:
        ...
        f.write('/////////////////////////////////////////////////////////////////\n')
        f.write('Maximum test 10 accuracy = ' + str(max_test_10_accuracy) + '%\n')
        f.write('Minimum test 10 accuracy = ' + str(min_test_10_accuracy) + '%\n')
        f.write('Average test 10 accuracy = ' + str(avg_test_10_accuracy) + '%\n')
        f.write('Standard Deviation for test 10 accuracy = ' + str(std_test_10_accuracy) + '\n')
        f.write('/////////////////////////////////////////////////////////////////\n')
